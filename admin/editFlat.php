...
include "./functions/flatEdit_functions.php"
?>
...
<div class="col-6 mt-5">
     <div class="card">
          <div class="card-body">
               <div>
                    <span class="text-center h4">Edit Flat</span>
                    ...
                    <div class="col-12 p-4">
                         <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                   ...
                                   <div class="col-md-6">
                                        <div class="form-outline mb-4">
                                             ...
                                             <input type="text" name="price" id="form2Example1" class="form-control <?php echo (!empty($price_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $price; ?>" placeholder="Enter Price" />
                              ...
                              <div class="row">
                                   <div class="col-12">
                                        <div class="form-outline mb-4">
                                             ...
                                             <textarea class="form-control" name="short_description" cols="30" rows="3"><?php echo $short_description; ?></textarea>
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="form-group text-center">
                                   <input type="submit" style="background-color:#00B98E; color:white;" class="btn" value="Update Flat">
                              </div>
