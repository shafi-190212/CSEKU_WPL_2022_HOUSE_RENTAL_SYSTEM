  ...
  <div class="container my-5 py-5">
    ...
    <div class="grid-container">
      ...
      <div class="grid-items">
        ...
        <div class="container">
          <h2><i class="fa fa-dollar-sign"></i><?php echo $row['price'] ?></h2>
          ...
          ?>
          <a class="d-block h5 mb-2" href="house-details.php"><h3 class="text-primary text-center"><?php echo $house['house'] ?></h3></a>
